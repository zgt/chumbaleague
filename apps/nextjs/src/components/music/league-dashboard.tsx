...
export function LeagueDashboard() {
  ...
  const handleJoin = (e: React.FormEvent) => {
    ...
    router.push(`/join/${encodeURIComponent(inviteCode.trim())}`);
  };
    ...
    <div className="py-4">
      ...
      <div className="grid gap-6 md:grid-cols-3">
              ...
              {leagues.map((league) => {
                ...
                return (
                  <Link key={league.id} href={`/leagues/${league.id}`}>
                    <div className="glass-card cursor-pointer rounded-xl p-5">
        ...
        <div className="space-y-6">
          {/* Join League */}
          <div className="glass-card rounded-xl p-5">
            <h3 className="mb-4 text-lg font-semibold">Join a League</h3>
