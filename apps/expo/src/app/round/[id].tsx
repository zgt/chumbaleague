...
function getActiveStepIndex(status: string): number {
  ...
  return idx === -1 ? PHASE_STEPS.length : idx;
}
            ...
            <View style={{ padding: 16 }}>
              ...
              {round.status === "SUBMISSION" && (
                <SubmissionPhaseSection
                  roundId={id}
                  submissions={round.submissions.filter(
        ...
        {PHASE_STEPS.map((step, i) => {
          ...
          const circleText = isActive
            ...
            : isPast
              ? "#50C878"
              : "#8FA8A8";
          const labelColor = isActive || isPast ? "#50C878" : "#8FA8A8";
...
function ViewPlaylistButton({
  ...
  return (
    <View style={{ gap: 8, marginBottom: 16 }}>
      <Pressable
        onPress={() => router.push(`/round/${roundId}/playlist` as never)}
        style={{
          backgroundColor: "#102A2A",
          borderWidth: 1,
          borderColor: "#1DB954",
...
function VotingPhaseSection({
  ...
  return (
    <View style={{ gap: 12, marginBottom: 16 }}>
      ...
      >
        <Text style={{ color: pointsColor, fontSize: 14, fontWeight: "700" }}>
      ...
      {status !== "COMPLETED" && (
        ...
        >
          {advancePhaseMutation.isPending ? (
            ...
            <>
              <Text
                style={{ color: "#FFA500", fontSize: 13, fontWeight: "600" }}
              >
                Advance Phase
              </Text>
