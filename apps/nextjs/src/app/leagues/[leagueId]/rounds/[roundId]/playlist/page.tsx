            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1 text-xs">
                  To save these tracks as a Spotify playlist: open Spotify,
                  create a new playlist, then use &ldquo;Copy all track
                  links&rdquo; above and search for each track to add it. Or,
                  click each track&apos;s Spotify link and add it to your
                  playlist from there.
                </p>
              </div>
            </div>
